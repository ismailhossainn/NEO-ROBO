...
function computePlatformDimensions() {
   ...
   if (pmvImg) {
       PLAT_MOVING_H = 90;
       PLAT_MOVING_W = PLAT_MOVING_H * (pmvImg.w / pmImg.h);
   }
}
...
const Game = {
   ...
   // ===== BOSS SUDHU DAN DIK THEKE ASHBE =====
   spawnBoss(isMainBoss = false) {
       ...
       // === BOSS ALWAYS SPAWNS FROM RIGHT SIDE (dan dik theke) ===
       ...
       const boss = {
           ...
           dir: -1,  // === dir = -1 means moving LEFT toward player ===
           alive: true,
