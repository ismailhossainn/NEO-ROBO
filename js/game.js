...
const Game = {
    ...
    spawnBoss(isMainBoss = false) {
        ...
        // === BOSS ALWAYS SPAWNS FROM LEFT SIDE (bam dik theke) ===
        const spawnX = this.cameraX - bw - 80 - Math.random() * 200;
        const availableRobots = ASSETS.robots.filter((_, i) => i !== this.selectedRobot);
        ...
        const boss = {
            ...
            dir: 1,  // === dir = 1 means moving RIGHT toward player ===
            alive: true,
