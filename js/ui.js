...
const ROBOT_COLORS = {
    'MRK-069': { primary: '#ff6600', light: '#ff9944', dark: '#cc4400', glow: 'rgba(255, 102, 0, 0.8)' },
    'MRK-301': { primary: '#00ccff', light: '#66ddff', dark: '#0099cc', glow: 'rgba(0, 204, 255, 0.8)' },
    'MRK-608': { primary: '#ff00cc', light: '#ff66dd', dark: '#cc0099', glow: 'rgba(255, 0, 204, 0.8)' },
    'MRK-720': { primary: '#ffcc00', light: '#ffdd55', dark: '#cc9900', glow: 'rgba(255, 204, 0, 0.8)' },
    'MRK-830': { primary: '#00ff88', light: '#66ffaa', dark: '#00cc66', glow: 'rgba(0, 255, 136, 0.8)' }
};
